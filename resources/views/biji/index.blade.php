...
<div id="book">
    ...
    <div style="float: right;margin: 15px 15px;cursor: pointer">
        <a class="atip" href="{{ url('/book/create') }}" data-toggle="tooltip" data-placement="bottom" title="创建笔记本"><img src="{{ asset('/images/addBook.png') }}"></a>
    </div><br/><br/>
...
<div id="search" class="form-horizontal" role="form">
    ...
    <form method="GET" action="{{ url('/biji/') }}">
        <input type="text" name="search_biji" class="form-control" placeholder="搜索笔记" style="height: 50px;"/><br/>
        <div class="form-group">
            <div class="col-md-12">
                <label>选择笔记本</label>
