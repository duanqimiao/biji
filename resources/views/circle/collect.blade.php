...
@section('content')
    <h3><a style=";color: #666666" href="/circle/">朋友圈</a> <small>» 我的收藏 </small></h3>
    ...
    @foreach($collects as $collect)
        <div style="display: none">{{ $collect_bijis = \App\Biji::where('id',$collect->biji_id)->get() }}</div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="lead">
                                            ...
                                            您确定不再收藏笔记{{ $bijis->title }}?
                                        </p>
                                    </div>
                                    <div class="modal-footer">
                                        <form method="POST" action="{{ url('/collect/'.$bijis->id) }}">
